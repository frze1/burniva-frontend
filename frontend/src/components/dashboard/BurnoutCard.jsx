      ...
      <div className="relative z-10 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 bg-white/10 p-5 rounded-2xl border border-white/20 backdrop-blur-md shadow-xl w-full xl:w-auto">
          ...
          <div className="flex flex-col items-center sm:items-start">
            <span className="text-white/80 text-xs font-semibold uppercase tracking-wide mb-1">Skor Burnout</span>
          ...
          {/* Status */}
          <div className="flex flex-col items-center sm:items-start">
            <span className="text-white/80 text-xs font-semibold uppercase tracking-wide mb-2">Status Saat Ini</span>
          ...
          <button
            ...
            className="w-full sm:w-auto bg-white text-primary-500 hover:bg-gray-100 text-sm font-medium px-5 py-3 rounded-xl transition-all flex items-center justify-center gap-2"
          >
