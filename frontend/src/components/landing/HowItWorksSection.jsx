...
function HowItWorksSection() {
  return (
    <section id="cara-kerja" className="py-14 md:py-20 bg-slate-50">
      <div className="w-full px-4 md:px-16 lg:px-24">

        <div className="text-center mb-10 md:mb-12">
          <p className="text-xs md:text-sm font-medium text-primary-600 mb-2">Cara Kerja</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
          {steps.map(({ number, title, description }) => (
            <div key={number} className="flex flex-col">
              <span className="text-3xl md:text-4xl font-bold text-primary-200 mb-2 md:mb-3">{number}</span>
